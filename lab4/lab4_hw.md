...
```
##            taxon     common_name           class                     order    
##  mammals      :238   Length:569         Length:569         perciformes  : 88  
##  birds        :140   Class :character   Class :character   rodentia     : 77  
##  marine fishes: 90   Mode  :character   Mode  :character   passeriformes: 70  
##  snakes       : 41                                         carnivora    : 56  
##  river fishes : 14                                         squamata     : 52  
##  turtles      : 14                                         artiodactyla : 39  
##  (Other)      : 32                                         (Other)      :187  
##     family             genus             species          primarymethod     
##  Length:569         Length:569         Length:569         Length:569        
##  Class :character   Class :character   Class :character   Class :character  
...
##          primarymethod    n mean_mass_g log10_mass
...
##                      species      primarymethod    n mean_mass_g  log10_mass
...
```
##   mean_mass_g log10_mass    family      genus     species        order
## 1       61.32   1.787602 strigidae glaucidium  passerinum strigiformes
## 2      119.00   2.075547 strigidae   aegolius    funereus strigiformes
## 3      156.50   2.194514 strigidae     athene      noctua strigiformes
## 4      252.00   2.401401 strigidae       asio        otus strigiformes
## 5      285.00   2.454845 tytonidae       tyto        alba strigiformes
## 6      519.00   2.715167 strigidae      strix       aluco strigiformes
## 7     1510.00   3.178977 strigidae       bubo virginianus strigiformes
## 8     1920.00   3.283301 strigidae     nyctea   scandiaca strigiformes
## 9     2191.00   3.340642 strigidae       bubo        bubo strigiformes
```
...
```
##      mean_hra_m2         species                    common_name class
