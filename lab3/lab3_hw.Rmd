...
sleepiest
```
By filtering out the observations in the sleep_total variable that do not fit the criteria of the sleep_total being "really equal" to 19.90, the maximum sleep_total value identified with the summary function, we get the sleepiest mammal in the "sleep" dataframe as the Little Brown Bat.
