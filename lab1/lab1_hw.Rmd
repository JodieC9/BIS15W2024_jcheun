...
**2. What is the difference between R and RStudio? What is GitHub and why is it useful to programmers?**  R itself is the program and scripting language used to perform coding and statistics. R studio is a graphical user interface (GUI) that contains graphical representations of the program functions provided in R. R Studio can not work independently of R since R is the actual program running the lines of code being entered. GitHub 
