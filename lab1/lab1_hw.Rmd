...
R itself is the program and scripting language used to perform coding and statistics. R studio is a graphical user interface (GUI) that contains graphical representations of the program functions provided in R. R Studio can not work independently of R since R is the actual program running the lines of code being entered. GitHub is an online area where various programmers can put,save, and collaborate on various coding projects. Through the Git program, GitHub will track changes made in the code and restore previous versions of coding projects. Personally, I can best understand the collboration aspect of GitHub by imagining it as the "Google Drive" for coding purposes. 
