...
surgery %>%
  ...
  labs(title = "Distribution of BMI per Health Status",
       ...
       y="Health Status")
```
Box plots do show a range, but are only showing differences on the x axis, nothing is shown on the y-axis
Density shows differences along both axis 
...
*Wrong* If you just arrange each of the procedures you get repeats observations of the same procedure. You need to add up the complication rate for each recorded procedure and the compare the resulting totals 

Using mean is more accurate than taking the sum of something *Use mean for comparison problems*
