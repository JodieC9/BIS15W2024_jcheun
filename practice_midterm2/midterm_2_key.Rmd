...
```
Prof addresses the first part of the question with the mort rate 
...
```
Prof addresses the second part of the question with the complication rate 
...
```
Now knowing the specific operations that correlated to the top 5 mort rates and complication rates we represent these in a single chart with the means of both rates PER procedure 
