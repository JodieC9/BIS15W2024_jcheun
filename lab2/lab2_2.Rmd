...
```{r}
#For R to look into the vector and evaluate the sequence 
my_vector_sequence==15
#Doing this code will give you the specific position where the statement is true. 
...
#Notice that the code output was the actual numbers, not the evaluation from the entire data set of which numbers are <= to 10 
```
...
#This code tells you the sum of profits from both US and non-US 
```
...
## Practice
1. What are the total earnings for the US and non-US regions? AKA making sum of the columns
```{r}
...
#r bind is row bind. It will add a new row to the data matrix 
```
